...
const Hero = () => {
  ...
  const paragraphText = "We’re the architects of digital excellence across industries. We redefine business with cutting-edge digital strategies that invoke sector-wide transformation.";
  ...
  return (
    <div className="mx-12 h-fit rounded-[3rem] bg-white/10 p-16 space-y-7">
      ...
      <motion.p
        initial="hidden"
        whileInView="visible"
        className="text-light-grey/70 w-3/4 tracking-wide leading-relaxed text-lg"
      >
